...
const roles = [
  ...
  },
  {
    ...
    period: "2022 - 2023",
    description: "Led end-to-end launch of a Campaign Creation and Marketplace MVP generating $800K+ in quarterly revenue. Defined roadmap for the Intelligent Sending platform.",
    metric: "$800K",
